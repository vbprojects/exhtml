...
define i64 @driver() local_unnamed_addr {
top:
  ...
  store {}* inttoptr (i64 2733348215776 to {}*), {}** %2, align 8
  %3 = getelementptr inbounds [5 x {}*], [5 x {}*]* %0, i64 0, i64 3
  store {}* inttoptr (i64 2732350835064 to {}*), {}** %3, align 8
  %4 = getelementptr inbounds [5 x {}*], [5 x {}*]* %0, i64 0, i64 4
  store {}* inttoptr (i64 2732350835120 to {}*), {}** %4, align 8
  %5 = call nonnull {}* @ijl_invoke({}* inttoptr (i64 140711627441600 to {}*), {}** nonnull %.sub, i32 5, {}* inttoptr (i64 2733531013184 to {}*))
  %6 = bitcast {}* %5 to i64*
